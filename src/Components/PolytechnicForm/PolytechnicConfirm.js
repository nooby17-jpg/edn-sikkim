...
export class PolytechnicConfirm extends Component {
    continue = e => {
        e.preventDefault();
        // PROCESS FORM //
        this.props.nextStep();
    ...
    render() {
        const {
            values: {district, institution, course, passing_year, board, prev_school, student_name, father_name, roll_number, Aadhaar_number, parent_mobile,student_mobile, email, english, mathematics, science  }
        } = this.props;
        return (
            <MuiThemeProvider>
                <>
                    ...
                    >
                        ...
                        <List>
                            ...
                            <ListItem>
                                <ListItemText primary="Science :" secondary={science} />
                            </ListItem>
                            <ListItem>
...
export default PolytechnicConfirm ;
